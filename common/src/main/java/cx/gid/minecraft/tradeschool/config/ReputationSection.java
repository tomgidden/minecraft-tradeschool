...
public class ReputationSection {
    ...
    @Comment({"MINOR_POSITIVE per lesson. Weight 1, caps at 25, decays slowly.",
              "Improves prices noticeably without reaching cure-tier discounts."})
    public int minorPositive = 0;

    @Comment({"MAJOR_POSITIVE per lesson. Weight 5, caps at 20, never decays.",
              "This is curing's currency; granting much of it makes teaching permanent."})
    ...
    @Comment({"TRADING gossip per lesson. Weight 1, caps at 25, decays faster than",
              "MINOR_POSITIVE. An ordinary trade grants 2."})
