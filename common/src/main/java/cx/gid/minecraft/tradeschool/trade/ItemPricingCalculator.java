...
public class ItemPricingCalculator
{
  ...
  private static int getEnchantmentValue(Holder<Enchantment> enchantment)
  {
    ...
    if(enchantId.contains("infinity") || enchantId.contains("silk_touch") || enchantId.contains("channeling") || enchantId.contains("frost_walker")) {
      return 6;
    }

    // Rare enchantments
    if(enchantId.contains("fortune") || enchantId.contains("looting") || enchantId.contains("sharpness") || enchantId.contains("protection")) {
      return 4;
    }
