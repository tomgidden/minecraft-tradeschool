...
public class FillerTrade {
    ...
    @Comment({"The exact villager level this unlocks at, not a minimum.",
              "Vanilla appends each level's trades on promotion rather than rebuilding, so a",
              "minimum would re-add the trade at every rank above it."})
    public int level = 1;
    ...
    @Comment({"How much the price responds to reputation and demand.",
              "0.05 is vanilla's figure for commodity trades like these."})
