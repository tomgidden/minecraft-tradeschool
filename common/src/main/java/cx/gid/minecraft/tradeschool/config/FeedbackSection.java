...
public class FeedbackSection
{
  ...
  @Comment({"Action bar, above the hotbar. Unobtrusive, but it cannot be held on screen", "long enough to read a sentence."})
  public boolean actionBar = false;

  @Comment("Centre-screen title on a successful lesson.")
  public boolean title = false;

  @Comment({"Title timing in ticks: fade in, hold, fade out. 20 ticks to the second.", "Stated as a whole because the three only make sense together."})
