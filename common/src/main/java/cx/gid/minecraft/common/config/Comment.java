...
///
/// Javadoc would be the natural home for this, but it is discarded at compile
/// time and so cannot be read when the reference file is generated. Annotating
/// the field keeps the explanation next to what it explains, which a separate
