...
Note, even if you then upgrade them to a higher level, they'll still only offer the original trade: villagers are too stupid to remember and then extrapolate to the new materials they can work. So, you'll have to teach them again.

### Why is gold treated specially?

Gold tools and weapons are valid at any weaponsmith/toolsmith level and kept as gold (not downgraded to wood). While gold items are weaker, they have extra benefits, like higher maximum enchantability. Gold armor pacifies Piglins in the nether, and Gold tools have the highest efficiency.

So, they're treated as "side branches" of the main material tech tree, as there are niche reasons why you might want a couple of gold items even if you have everything else in netherite.
...
(Psst. It is possible to configure it to enable Netherite teaching. I recommend not doing so.)
...
If the trade results in a downgrade (lower material, capped enchantments, or stripped customisation), you get the item back instead. This way you can keep iterating: teach at level 1, get a wooden sword back, level the villager up, teach again with the same diamond sword.
...
### Why can't I teach a villager an item with Curse of Copyright?
